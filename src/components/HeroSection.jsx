...
const HeroSection = () => {
  return (
    <div className='flex items-center justify-center h-screen flex-col leading-7 container'>
         <h1 class="text-6xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
